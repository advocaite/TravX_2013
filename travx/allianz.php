...
include_once($ugamela_root_path . 'includes/function_attack.php');
include_once($ugamela_root_path . 'includes/function_status.php');
include_once($ugamela_root_path . 'includes/function_troop.php');
include_once($ugamela_root_path . 'includes/function_resource.php');
include_once($ugamela_root_path . 'includes/wordFilter.php');
