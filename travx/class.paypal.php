...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      foreach ($this->fields as $name => $value) {
          ...
          echo '</td>';
          echo '</tr>';
      echo '<th class="errormessage"><h3>Your request is being processed and you will be automatically redirected to the PayPal site.</h3><br><br>This process takes 5 seconds. If you are not redirected automatically...<br><br><input type="submit" value="Click here"></th>';
          echo '</table>';
          echo '</form>';
