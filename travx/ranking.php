...
if(empty($tab)){
	$parse['active1'] = active;
}elseif($tab == 1){
	$parse['active2'] = active;
}elseif($tab == 2){
	$parse['active3'] = active;
}elseif($tab == 3){
	$parse['active4'] = active;
}elseif($tab == 4){
	$parse['active5'] = active;
}elseif($tab == 5){
	$parse['active6'] = active;
}elseif($tab == 6){
	$parse['active7'] = active;
}elseif($tab == 7){
	$parse['active8'] = active;
}else{
	$parse['active1'] = active;
}
...
/*elseif($_GET['tab'] == 7)
{
	require_once('includes/wg_troops.php');
	global $wg_troops;
	$rank=1;
	$tpl='ranking_hero';
