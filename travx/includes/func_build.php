...
define('Time_Delete',0.8); // Demolish time 80% of building
...
/*-------------------------------------------------------------------------------------------------------------------------
* @Author: duc hien
* @Des: Add workers each level
* @param: $level
* @return: No. of employees corresponds to the level passed
*/
...
/*
* @Author: duc hien
* @Des: scoring formula fame of the resources and structures
* @param: $level
...
function SCn_eco_cra($level)
{
	...
	{	
		return $level*$speed*$hs[$_SESSION['nation_id']];
	}
	else
	{
		global $user;		
		return $level*$speed*$hs[$user['nation_id']];
	}
}
...
function SCn_eco_oth($level)
{
	...
	$value=array("0"=>800,"1"=>1200,"2"=>1700,"3"=>2300,"4"=>3100,"5"=>4000,"6"=>5000,"7"=>6300,"8"=>7800,"9"=>9600,"10"=>11800,"11"=>14400,"12"=>17600,"13"=>21400,"14"=>25900,"15"=>31300,"16"=>37900,"17"=>45700,"18"=>55100,"19"=>66400,"20"=>80000);
	return $value[$level]*30;
}

// Time to upgrade technology at workshop
function Tn_tec_wor($level,$MBn)
{
	return round((3000*pow(2-($level-1)/10,$level-1))*$MBn);
}
// Common technology times
function Tn_tec($level,$MBn)
{
...
function Tn_Crop($level,$MBn) // CT dung
{
	...
	$value=array("0"=>3,"1"=>5,"2"=>9,"3"=>15,"4"=>22,"5"=>33,"6"=>50,"7"=>70,"8"=>100,"9"=>145,"10"=>200,"11"=>280,"12"=>375,"13"=>495,"14"=>635,"15"=>800,"16"=>1000,"17"=>1300,"18"=>1600,"19"=>2000,"20"=>2450,"21"=>3050,"22"=>3750,"23"=>4600,"24"=>5650,"25"=>6950);
...
function Tn_Clay($level,$MBn) // CT dung
{
	...
	$value=array("0"=>3,"1"=>15,"2"=>27,"3"=>45,"4"=>66,"5"=>99,"6"=>150,"7"=>121,"8"=>300,"9"=>435,"10"=>600,"11"=>840,"12"=>1125,"13"=>1485,"14"=>1905,"15"=>2400,"16"=>3000,"17"=>3900,"18"=>4800,"19"=>6000,"20"=>7350,"21"=>9150,"22"=>11250,"23"=>13800,"24"=>16950,"25"=>20850);
	return round($value[$level]*$MBn);	
}
...
/*-------------------------------------------------------------------------------------------------------------------------------
* @Author: duc hien
* @Des:	Resource level gain in each level
* @param: $level
* @return: suc tang cua tai nguyen tuong ung voi level do'
*/
//Rate of extraction resources.
...
function ShowBuild($id,$wg_status)
{
	...
	if($statusList)
	{
		...
		foreach($statusList as $status)
		{
			...
			$parse['content']="".$lang[GetNameRS($status->object_id)]." <span class=\"lvl\">".$lang['level']." ".$level.")</span>";
			$parse['i']=$i;
...
function InsertDataBuilding_New($village_id,$userid,$kind_id,$isnew=0)
{
	...
	if($count==0)
	{
//		if($isnew == 1){ $kind_id = 3; }elseif($kind_id < 1){ $kind_id=3; }else{$kind_id = $kind_id > 6 ? 3 : $kind_id; }
		if($kind_id == FALSE){ $kind_id = 3; }
		...
		if($image)
		{
			...
			$sql.="(35,'Main_Building','images/un/g/g15.gif',1,$village_id, 12,100,".CPn_1(1)."),";	
		...
		{
			die('I cannot do something, report this bug to the administrator or to the forum! <br/><b>DEBUG NOTES:</b><br/>'.mysql_error().'<br/>DEBUG2<br/>'.$sql);
		}
	}
	return false;
}
...
function Buil_Infrastructure_New($type,$userid,$building_types,$id,$village,$a,$b,$c,$d,$Main_time)
{
	...
	if($count==0 || $building_types==36)
	{
		...
		{
			$images='<img src="images/un/g/kydai10.gif" border="0">';
		}
...
function Get_Images1($id,$level) // hinh anh cac cong trinh chua xay xong
{
	if($id==5) //grian mill
	{
		return $images='images/un/g/g8b.gif';
	}
	elseif($id==6) //Sawmill
	{
		return $images='images/un/g/g5b.gif';
	}
	elseif($id==7) //Brickyard
	{
		return $images='images/un/g/g6b.gif';
	}
	elseif($id==8) //Iron_Foundry
	{
		return $images='images/un/g/g7b.gif';
	}
	elseif($id==9) //Bakery
	{
		return $images='images/un/g/g9b.gif';
	}
	elseif($id==10) //Warehouse
	{
		return $images='images/un/g/g10b.gif';
	}
	elseif($id==11) //Granary
	{
		return $images='images/un/g/g11b.gif';
	}
	elseif($id==12) //Main buidling
	{
		return $images='images/un/g/g15b.gif';
	}
	elseif($id==13) //Marketplace
	{
		return $images='images/un/g/g17b.gif';
	}
	elseif($id==14) //Embassy
	{
		return $images='images/un/g/g18b.gif';
	}
	elseif($id==15) //Cranny
	{
		return $images='images/un/g/g23b.gif';
	}
	elseif($id==18) //Palace
	{
		return $images='images/un/g/g26b.gif';
	}
	...
	{
		return $images='images/un/g/g28b.gif';
	}
	elseif($id==24) //Blacksmith
	{
		return $images='images/un/g/g12b.gif';
	}
	elseif($id==27) //Rally_Poin
	{
		return $images='images/un/g/g16b.gif';
	}
	elseif($id==28) //Barracks
	{
		return $images='images/un/g/g19b.gif';
	}
	elseif($id==29) //Stable
	{
		return $images='images/un/g/g20b.gif';
	}
	elseif($id==30) //Workshop
	{
		return $images='images/un/g/g21b.gif';
	}
	elseif($id==31) //Academy
	{
		return $images='images/un/g/g22b.gif';
	}
	elseif($id==35) //Hero_Mansion
	{
		return $images='images/un/g/g37b.gif';
	}
	elseif($id==37) //World_Wonder  	
	{
		return $images='images/un/g/kydai1.gif';
	}
	return NULL;
}
/*-------------------------------------------------------------------------------------------------------------------------------
...
function Get_Images2($id,$level) // hinh anh cac cong trinh sau khi hoan thien
{
    if($id==5) //grian mill
	{
		return $images='images/un/g/g8.gif';
	}
	elseif($id==6) //Sawmill
	{
		return $images='images/un/g/g5.gif';
	}
	elseif($id==7) //Brickyard
	{
		return $images='images/un/g/g6.gif';
	}
	elseif($id==8) //Iron_Foundry
	{
		return $images='images/un/g/g7.gif';
	}
	elseif($id==9) //Bakery
	{
		return $images='images/un/g/g9.gif';
	}
	elseif($id==10) //Warehouse
	{
		return $images='images/un/g/g10.gif';
	}
	elseif($id==11) //Granary
	{
		return $images='images/un/g/g11.gif';
	}
	elseif($id==12) //Main buidling
	{
		return $images='images/un/g/g15.gif';
	}
	elseif($id==13) //Marketplace
	{
		return $images='images/un/g/g17.gif';
	}
	elseif($id==14) //Embassy
	{
		return $images='images/un/g/g18.gif';
	}
	elseif($id==15) //Cranny
	{
		return $images='images/un/g/g23.gif';
	}
	elseif($id==18) //Palace
	{
		return $images='images/un/g/g26.gif';
	}
	elseif($id==19) //Treasury
	{
	...
	elseif($id==20) //Trade_Office
	{
		return $images='images/un/g/g28.gif';
	}
	elseif($id==24) //Blacksmith
	{
		return $images='images/un/g/g12.gif';
	}
	elseif($id==27) //Rally_Poin
	{
		return $images='images/un/g/g16.gif';
	}
	elseif($id==28) //Barracks
	{
		return $images='images/un/g/g19.gif';
	}
	elseif($id==29) //Stable
	{
		return $images='images/un/g/g20.gif';
	}
	elseif($id==30) //Workshop
	{
		return $images='images/un/g/g21.gif';
	}
	elseif($id==31) //Academy
	{
		return $images='images/un/g/g22.gif';
	}
	elseif($id==35) //Hero_Mansion
	{
		return $images='images/un/g/g37.gif';
	}
...
function getImagesWonder($level)
{
	if($level<=10)
		return $images='images/un/g/kydai1.gif';
	elseif($level<=20)
		return $images='images/un/g/kydai2.gif'; 
	elseif($level<=30)
		return $images='images/un/g/kydai3.gif'; 
	elseif($level<=40)
		return $images='images/un/g/kydai4.gif'; 
	elseif($level<=50)
		return $images='images/un/g/kydai5.gif'; 
	elseif($level<=60)
		return $images='images/un/g/kydai6.gif'; 
	elseif($level<=70)
		return $images='images/un/g/kydai7.gif'; 
	elseif($level<=80)
		return $images='images/un/g/kydai8.gif'; 
	elseif($level<=90)
		return $images='images/un/g/kydai9.gif'; 
	elseif($level<=100)
		return $images='images/un/g/kydai10.gif'; 
}
