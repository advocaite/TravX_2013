...
function GetRSStatus(){
	...
	$parse["rs1"]=$rs1=$wg_village->rs1;
	$parse["rs2"]=$rs2=$wg_village->rs2;
	$parse["rs3"]=$rs3=$wg_village->rs3;
	$parse["rs4"]=$rs4=$wg_village->rs4;
	$parse['capacity_123']=$wg_village->capa123;
	$parse['capacity_4']=$wg_village->capa4;
/*	
	$parse['proc1'] = round((($rs1/$wg_village->capa123)*100),0);
	$parse['proc2'] = round((($rs2/$wg_village->capa123)*100),0);
	$parse['proc3'] = round((($rs3/$wg_village->capa123)*100),0);
	$parse['proc4'] = round((($rs4/$wg_village->capa4)*100),0);
	$parse['proc5'] = round((($wg_village->troop_keep+$wg_village->workers/$wg_village->speedIncreaseRS4)*100),0);
	if($parse['proc5'] > 100){ $parse['proc5'] = 100; }*/
