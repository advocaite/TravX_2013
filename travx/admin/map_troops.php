...
else
{
	...
	switch($_GET['s'])
	{
		...
		default:			
			...
			$parse ['show_combo_type'].='<option value="1" >Ministry</option>';
			$parse ['show_combo_type'].='<option value="2" >Horses</option>';
			$parse ['show_combo_type'].='<option value="3" >Palace</option>';
