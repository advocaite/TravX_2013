  ...
  <div id="content">
    <form action="" method="post" name="form_send_message" onSubmit="return CheckInput();">
	  <table width="100%" align="center">
        <tr align="left">
          <td class="c" colspan=5 align="center"><b style="color:#FF0000">Send message in group</b></td>
        </tr>
		<tr align="left">
...
<input onfocus="setTypingMode(0)" value="OFF" name="switcher" type="radio" tabindex="3" checked="checked"><b>Off&nbsp;&nbsp;</b></div> </td>
		</tr>
        <tr align="left">
          <td width="21%"><strong>Group</strong> :</td>
          <td > <select name="group" id="1" onchange="Disiable('2','3');" class="fm">
              <option value="-1" selected="selected">-- Select --</option>
              <option value="0">All users</option>
              <option value="1">100 user highest rating</option>
              <option value="2">100 user the lowest ranking</option>
              <option value="3">100 user new users</option>
            </select>&nbsp;&nbsp;<span id="1_enable"></span>
          </td>
        </tr>  
		<tr>
          <td width="21%"><strong>Ally</strong>:</td>
        ...
        <tr>
          <td colspan="3" class="c" align="right">
          	<input type="reset" value="Reset" class="fm"/>
          </td>
          <td width="48%" colspan="2" align="left" class="c">
          <input type="submit" value="Send"  name="send" class="fm"/></td>
        </tr>
      </table>     
    </form>
  </div>
