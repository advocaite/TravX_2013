...
<p>
	<p> 
		&raquo;&raquo;Contribution of fame for alliance:
	</p>
	<p>
		Points: <input name="input_diemDV" type="text" value="{total_point}" class="fm" onkeyup="CheckNumberInput(this);" /> <input type="submit" value="Ok" />
	</p>
</p>
</form>
