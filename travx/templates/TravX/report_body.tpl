...
<td class="s7" colspan="2">
	<input type="submit" value="Check All" name="CheckAll" onClick="checkall()">
	<input type="submit" value="UnCheck All" name="UnCheckAll"onClick="uncheckall()">
	<input type="hidden" name="delete" style="visibility:hidden;"/>
	<input type="submit" name="delete" ondblclick="return check_checkbox()">
</td>
