...
<table cellspacing="1" cellpadding="2" class="tbg">
	...
	<input type="submit" name="Preview" value="Previous" {enablePreview} />
	</form>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<form method="post" action="report_detail.php?id={reportId}{typeTab}" style="display:inline">
	<input type="hidden" name="Del" value="1" />
	<input type="submit" name="imgDel" value="Delete" />
	</form>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<input type="submit" name="Next" value="Next" {enableNext} />
	</form>
