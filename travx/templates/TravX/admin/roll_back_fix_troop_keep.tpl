...
<div id="column-content">
  <div id="content">
	...
	<form name="frm_user_list" method="POST">
      ...
      <table width="100%">
        <tr>
          <td align="center"><b style="color:#FF0000">Update troopkeep</b></td>
        </tr>
      </table>      
      <table width="100%">       
        <tr>
          <td width="25%"></td>
          <td width="32%" align="left"><strong>Village </strong>:
          <input  type="text" name="village" class="fm f80" value="" /></td>
		  <td width="43%"><input type="submit" class="fm fm110" value="Update" onclick="return PopUp('village');"  /></td>
        </tr>
		 <tr>
           <td></td>
		   <td align="left"><strong>All</strong>:<input  type="checkbox" name="full" id="full" /></td>
