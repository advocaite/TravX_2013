...
include_once('includes/nation_troop.php');
include_once('includes/func_build.php');
include_once('includes/func_convert.php');
include_once('includes/function_resource.php');
include_once('includes/function_status.php');
include_once('includes/function_trade.php');
include_once('includes/function_troop.php');
include_once('includes/function_attack.php');
include_once('includes/func_security.php');
include_once('auth/call.php');
include_once('includes/wordFilter.php');
include_once('includes/wg_config_plus.php');
echo $error;
